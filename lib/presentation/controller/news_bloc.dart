...
class NewsBloc extends Bloc<NewsEvent, NewsState> {
  ...
  FutureOr<void> _getAppleArticles(
    ...
    emit(state.copyWith(appleArticlesState: RequestState.loading));
  ...
  FutureOr<void> _getBuisnessArticles(
    ...
    emit(state.copyWith(buisnessArticlesState: RequestState.loading));
  ...
  FutureOr<void> _getTeslaArticles(
    ...
    emit(state.copyWith(teslaArticlesState: RequestState.loading));
  ...
  FutureOr<void> _getWallStreetArticles(
    ...
    emit(state.copyWith(wallStreetArticlesState: RequestState.loading));
